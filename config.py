...
config[
    'unhealthy_samples'] = "data/48/unhealthy_samples"  # path to pickle dump of processed healthy samples for training.
...
config['modelpath_inject'] = os.path.join("data", "models",
                                          "INJ")  # path to save/load trained models and normalization parameters for injector
config['modelpath_remove'] = os.path.join("data", "models",
                                          "REM")  # path to save/load trained models and normalization parameters for remover
