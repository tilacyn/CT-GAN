...
class DataLoader():
    def __init__(self, dataset_path, normdata_path=None, img_res=None):
...
class SegmentedDataLoader():
    def __init__(self, subset_number, img_res):
    ...
    def load_batch(self, batch_size):
        ...
        for i in range(self.subset_number):
            self.cur_loader = DataLoader(os.path.join('data', '48', 'unhealthy_samples_{}.npy'.format(i)), img_res=self.img_res)
